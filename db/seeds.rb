...
todo1 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Request Recs", done: false, note: "", due: Date.new(2019, 8, 23))
todo2 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Send Recs", done: false, note: "", due: Date.new(2019, 8, 23))
todo3 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Send Essay", done: false, note: "", due: Date.new(2019, 8, 23))
todo4 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Follow Up", done: false, note: "", due: Date.new(2019, 8, 23))
todo5 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Send Secondary", done: false, note: "", due: Date.new(2019, 8, 23))
todo6 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Interview", done: false, note: "", due: Date.new(2019, 8, 23))
todo7 = Todo.create!(user_id: user1.id, school_id: school191.id, task: "Send Thank Yous", done: false, note: "", due: Date.new(2019, 8, 23))
